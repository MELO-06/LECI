...
SIGNAL \inst|ALT_INV_decOut_n[6]~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\inst|ALT_INV_decOut_n[6]~0_combout\ <= NOT \inst|decOut_n[6]~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst|ALT_INV_decOut_n[6]~0_combout\,
	devoe => ww_devoe,
	o => \HEX0[6]~output_o\);
...
-- Equation(s):
-- \inst|decOut_n[6]~0_combout\ = (\SW[1]~input_o\ & ((\SW[3]~input_o\) # (\SW[2]~input_o\ $ (\SW[0]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[2]~input_o\ $ ((\SW[3]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011011010111100",
...
-- Equation(s):
-- \inst|decOut_n~4_combout\ = (\SW[2]~input_o\ & (\SW[3]~input_o\ & ((\SW[1]~input_o\) # (!\SW[0]~input_o\))))
